...
<head>
    ...
    <meta name="kaywords" content="registro de usuario, crear usuario, nuevo usuario">
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Grosso_Store</title>
...
<main class="form-signing w-100 m-auto">
    <form action="" method="post">
        ...
        <p class="mt-3 mb-3 text-muted" style="color:#000000" >Todos los Derechos Reservados Grosso_Store
        <%=displayDate()%></p>
    </form>
</main>
</div>
